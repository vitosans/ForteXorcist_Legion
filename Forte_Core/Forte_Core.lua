...
-- 26.07.2016 : Removed things related to the glyphs, contact : Bodo#2718
...
-- added check for spec detection
local function FW_RelevantSpec()
    FW.Spec = GetSpecialization();
    --FW:Show("SPEC "..FW.Spec);
end
...
-- 26.07.2016 : Manually removed glyph function
...
local function FW_ScanBags() -- send item counts regardless of installed modules to improve usefulness
    ...
    -- 26.07.2016 : Manually emoved glyph events
...
FW:RegisterToEvent("ACTIVE_TALENT_GROUP_CHANGED", FW_RelevantSpec);
