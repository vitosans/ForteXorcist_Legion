...
if FW.CLASS == "WARLOCK" then
	...
	if ST then
		...
		:AddChannel(63106,1,3) -- Siphon Life
		...
		:AddDebuff(146739,  14,"Default",	F.TICKS):SetTickSpeed(2) -- Corruption, refresh by Life Drain, Drain Soul, Haunt
		:AddSpell(30108,  8,"Default",	F.TICKS):SetTickSpeed(2)--:SetStacks(5)-- Unstable Affliction, refresh by Fel Flame
		:AddSpell( 5740,   8,"Default",	F.AOE_DMG):SetTickSpeed(2) -- Rain of Fire
		
		--:AddSpellRemap(30108,233490)
		--:AddSpellRemap(30108,233496)
		--:AddSpellRemap(30108,233497)
		--:AddSpellRemap(30108,233498)
		--:AddSpellRemap(30108,233499)
 -- :AddSpell(233490, 8, "Default", F.REFRESH):SetTickSpeed(2)
  :AddSpell(233496, 8, "Default", F.TICKS):SetTickSpeed(2)
  --:AddSpell(233497, 8, "Default", F.TICKS):SetTickSpeed(2)
  --:AddSpell(233498, 8, "Default", F.TICKS):SetTickSpeed(2)
  --:AddSpell(233499, 8, "Default", F.TICKS):SetTickSpeed(2)
		...
		:AddSpell(18540,  25,"Pet",		F.SUMMON) -- Doomguard
		
		:AddSpell(111859, 25,"Pet",		F.SUMMON) -- Grimoire: Imp
		:AddSpell(111895, 25,"Pet",		F.SUMMON) -- Grimoire: Voidwalker
		:AddSpell(111896, 25,"Pet",		F.SUMMON) -- Grimoire: Succubus
		:AddSpell(111897, 25,"Pet",		F.SUMMON) -- Grimoire: Felhunter
		:AddSpell(111898, 25,"Pet",		F.SUMMON) -- Grimoire: Felguard
		...
		:AddCooldown(17962, 12):SetStacks(2):SetDefaultHasted(1) -- Conflag
