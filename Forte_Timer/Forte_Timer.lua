...
function ST:SetSpec(requires_spec)
    if not FW.Spec == requires_spec then Track[current_spell]["s"] = {};end
    if not FW.Spec == requires_spec then Track[current_spell]["s"] = 1;end
    return self;
end
